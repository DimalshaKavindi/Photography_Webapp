  ...
  return (
    <div>
      ...
      <nav style={{ position: "absolute", top: "30px", right: "20px", zIndex: "1", display: "flex", alignItems: "center" }}>
                <a href="/gallery" style={{ color: "white", marginLeft: "25px", marginRight: "20px", textDecoration: "none" }}>Back</a>
            </nav>
          <div style={{marginLeft:'100px', marginRight:'100px', paddingTop:'60px'}}>
            <p style={{display: "flex", flexDirection: "column", alignItems: "center" ,fontSize:'35px',fontWeight:'bold',fontFamily: 'Khand, sans-serif',color:'#DEB887'}}> {albumData.Album_Category}</p>
            <p style={{color:'white', fontSize:'25px', fontWeight:'bold'}}> {albumData.Name}</p>
